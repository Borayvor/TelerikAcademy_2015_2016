...
--2. Write a SQL query to find the names and salaries of the employees that have
...
--15. Write a SQL statement to create a table Users. Users should 
...
--24. Write a SQL statement that deletes all users without pass-
-- words (NULL password).
DELETE * 
    FROM Users
...
--27. Write a SQL query to display the town where maximal number 
-- of employees work.
...
--28. Write a SQL query to display the number of managers from 
-- each town.
...
--30. Start a database transaction, delete all employees from the 
...
--31. Start a database transaction and drop the table Employees-
-- Projects.
