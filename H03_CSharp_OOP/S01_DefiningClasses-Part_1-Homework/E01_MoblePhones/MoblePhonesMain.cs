namespace E01_MoblePhones
{
    ...
    public class MoblePhonesMain
    {
        public static void Main(string[] args)
        {
            ...
            // number of colors).
            // Define 3 separate classes (class GSM holding instances of the 
            ...
            //
            // 03. Enumeration:
            // Add an enumeration BatteryType (Li-Ion, NiMH, NiCd, …) and use it 
            ...
            //
            // 09. Call history:
            // Add a property CallHistory in the GSM class to hold a list of the performed 
            // calls. Try to use the system class List<Call>.
            //
            // 10. Add/Delete calls:
            // Add methods in the GSM class for adding and deleting calls from the calls 
